...
import { asyncTestCaseStorage, CreateTestCaseInput, UpdateTestCaseInput } from '../asyncTestCaseStorage';
import { testCaseStorage as opensearchTestCases } from '../opensearchClient';
import type { AgentContextItem } from '@/types';

// Mock the OpenSearch client
jest.mock('../opensearchClient', () => ({
  testCaseStorage: {
    getAll: jest.fn(),
    getById: jest.fn(),
    create: jest.fn(),
