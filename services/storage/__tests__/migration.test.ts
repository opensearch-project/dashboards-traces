...
jest.mock('../asyncTestCaseStorage', () => ({
...
jest.mock('../asyncExperimentStorage', () => ({
...
describe('Migration Service', () => {
  ...
  describe('migrateToOpenSearch', () => {
    ...
    it('should migrate test cases to OpenSearch', async () => {
      ...
      const { asyncTestCaseStorage } = require('../asyncTestCaseStorage');
    ...
    it('should migrate experiments to OpenSearch', async () => {
      ...
      const { asyncExperimentStorage } = require('../asyncExperimentStorage');
    ...
    it('should migrate reports to OpenSearch', async () => {
      ...
      const { asyncRunStorage } = require('../asyncRunStorage');
